...
A Machine Learning project to detect Parkinson’s Disease using biomedical voice measurements. Models used: SVM, Random Forest, XGBoost, and KNN, with SelectKBest for feature selection. The project uses dataset from Kaggle which has 195  observations and 23 attributes. The dataset is composed of a range of biomedical voice measurements of different patients. The source of the dataset is University of Oxford.
# Prerequisties
